...
export default function AuthNav() {
  ...
  // Hide logout button on session pages, password reset page, login page, and home page
  if (pathname.startsWith("/session/") || pathname === "/reset-password" || pathname === "/login" || pathname === "/") {
    return null;
  }
